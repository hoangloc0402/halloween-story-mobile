...
public class FireTrap extends Trap implements GameObject {
    ...
    public FireTrap(PointF postition, long timeBetweenTwoAnimation) {
        ...
        this.burningFire = new Animation(R.drawable.fire_10, frameWidth, frameHeight, 10, 500);
    ...
    public RectF getSurroundingBox() {
        ...
        surroundingBox.set(topLeft.x * scale + this.position.x - Constants.BACKGROUND_X_AXIS, topLeft.y * scale + this.position.y, bottomRight.x * scale + this.position.x - Constants.BACKGROUND_X_AXIS, bottomRight.y * scale + this.position.y);
